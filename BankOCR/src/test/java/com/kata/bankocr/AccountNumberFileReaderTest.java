...
@Test
public void readTheAccountNumberFileContainMultipleAccountNumberSuccess() throws URISyntaxException, IOException {
	ClassLoader loader = AccountNumberFileReaderTest.class.getClassLoader();
	...
	assertEquals("Expected characters in the first line is",  "    _  _     _  _  _  _  _ ",fileReader.getAccountNumbers().get(1).getLine1());
	assertEquals("Expected characters in the secoend line is","  | _| _||_||_ |_   ||_||_|",fileReader.getAccountNumbers().get(1).getLine2());
	assertEquals("Expected characters in the third line is",  "  ||_  _|  | _||_|  ||_| _|",fileReader.getAccountNumbers().get(1).getLine3());
}
